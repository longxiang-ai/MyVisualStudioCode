...
string value ::simplified(const string &str)
{
    string ret;
...
bool value ::isPreOfSci(const string &str, int i)
{
...
vector<string> value ::split(string &str)
{
...
void value ::stringSegCpy(string &des, const string &src, int begin, int end)
{
    des.clear();
...
int value ::countChar(const string &str, char ch)
{
    int ret = 0;
    for (int i = 0; i < str.size(); i++)
    {
...
bool value ::allNum(const string &str)
{
    if (str.size() == 0)
        return false;
    bool AllNum = true;
...
bool value ::isLegalInt(const string &str)
{
    if (allNum(str))
        return true;
    else
...
bool value ::allAlpha(const string &str)
{
    bool AllAlpha = true;
    for (int i = 0; i < str.size(); i++)
    {
...
bool value ::isAlphaNumFormat(const string &str)
{
    bool startNum = false;
    bool NumExist = false;
...
bool value ::isLegalRange(const string &str)
{
    bool OneColon = false;
...
bool value ::isLegalFloat(const string &str)
{
    if (countChar(str, '.') != 1)
        return false;
...
bool value ::isLegalPercentage(const string &str)
{
    if (countChar(str, '%') != 1)
        return false;
    // only a '%'
...
bool value ::isLegalFraction(const string &str)
{
    if (countChar(str, '/') != 1)
        return false;
...
bool value ::isLegalScientific(const string &str)
{
...
bool value ::isLegalValue(const string &str)
{
...
vector<double> value ::transform(const string &str)
{
    vector<double> ret;
    // integer
    if (isLegalInt(str))
...
bool value ::isFunc(const string &str)
{
    if (str == "SUM")
        return true;
    else if (str == "AVERAGE")
...
double value ::SUM(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::AVERAGE(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::COUNT(vector<double> parameter)
{
    return parameter.size();
}

double value ::MAX(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::MIN(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
        string NoPara("No Parameter for MAX!!!");
...
double value ::ABS(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::FACT(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::LN(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::LOG(vector<double> parameter)
{
    if (parameter.size() <= 1)
    {
...
double value ::SQRT(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::SIN(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::COS(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::TAN(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::ASIN(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::ACOS(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
double value ::ATAN(vector<double> parameter)
{
    if (parameter.size() == 0)
    {
...
void value ::pushLegalValue(stack<double> &valStack, stack<double> &paraStack,
...
bool value ::isLegalOp(const string &str)
{
    if (str == "+" || str == "-")
        return true;
    else if (str == "*" || str == "/")
...
bool value ::isFuncMode(int FuncCnt)
{
    return FuncCnt > 0;
}
...
void value ::processUniOp(stack<double> &s, char op)
{
    if (s.size() == 0)
    {
        string illExp("Illegal Expression!!!");
...
double value ::callFunc(stack<string> &funStack, stack<double> &paraStack, int paraNum)
{
    vector<double> para;
...
void value ::conductBiOp(stack<double> &vStack, stack<string> &opStack)
{
    string IllFunExp("Illegal Fun Expression!!!");
...
void value ::processBiOp(stack<double> &vStack, stack<string> &opStack, const string &op)
{
...
double value ::calSplitedExp(vector<string> tokens)
{
...
double value ::calValue(string &input)
{
